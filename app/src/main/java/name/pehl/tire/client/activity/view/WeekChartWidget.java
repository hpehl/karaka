 ...
 *          $
 */
public class WeekChartWidget extends Widget implements HasActivitiesNavigationHandlers
{
    ...
    private native JavaScriptObject initTitle(JavaScriptObject raphael, int x, int y, String title, int rectX,
        ...
        var safeThis = this;
        var color = @name.pehl.tire.client.activity.view.WeekChartWidget::TEXT_COLOR;
        var bgColor = @name.pehl.tire.client.activity.view.WeekChartWidget::BACKGROUND_COLOR;
        ...
        safeThis.@name.pehl.tire.client.activity.view.WeekChartWidget::onCurrent()();
        };
        return text;
    }-*/;
    ...
    private native JavaScriptObject initPrev(JavaScriptObject raphael, String path, int rectX, int rectY,
        ...
        safeThis.@name.pehl.tire.client.activity.view.WeekChartWidget::onPrev()();
        };
    ...
    private native JavaScriptObject initNext(JavaScriptObject raphael, String path, int rectX, int rectY,
        ...
        safeThis.@name.pehl.tire.client.activity.view.WeekChartWidget::onNext()();
        };
    ...
    private native JavaScriptObject initColumn(JavaScriptObject raphael, String path) /*-{
        var color = @name.pehl.tire.client.activity.view.WeekChartWidget::COLUMN_COLOR;
