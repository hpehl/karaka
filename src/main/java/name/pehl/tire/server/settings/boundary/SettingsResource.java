package name.pehl.tire.server.settings.boundary;
...
import name.pehl.tire.server.settings.control.SettingsConverter;
...
public class SettingsResource
{
    ...
    @GET
    public name.pehl.tire.shared.model.Settings currentSettings()
    {
