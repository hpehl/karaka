package name.pehl.tire.server.client.boundary;
...
public class ClientsResource
{
    ...
    @GET
    public List<name.pehl.tire.shared.model.Client> list()
    {
        ...
        List<name.pehl.tire.shared.model.Client> result = new ArrayList<name.pehl.tire.shared.model.Client>();
