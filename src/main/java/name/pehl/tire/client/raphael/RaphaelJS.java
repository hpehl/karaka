...
public class RaphaelJS extends JavaScriptObject
{
    ...
    protected static class Element extends JavaScriptObject
    {
         ...
         *                   [“butt”, “square”, “round”] . stroke-linejoin
         *                   string [“bevel”, “round”, “miter”] .
         *                   stroke-miterlimit number . stroke-opacity number .
         *                   stroke-width number . translation string comma or
         *                   space separated values: x and y . width number . x
         *                   number . y number
         * @param value
