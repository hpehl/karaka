...
public class Raphael extends Widget
{
    ...
    /**
     * detach our children explicitly here since they were attached via
     * JavaScript outside of GWT framework
     */
    @Override
    ...
    public class Shape extends Widget
    {
        ...
        /**
         * this is ugly, but necessary for the parent Raphael widget to detach
         * this widget from the DOM, because the onDetach() method is protected.
         */
    ...
    public class Path extends Shape
    {
        ...
        /**
         * doesn't seem to work public String getSubpath(int from, int to) {
